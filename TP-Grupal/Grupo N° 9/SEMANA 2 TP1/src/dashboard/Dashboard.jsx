  ...
  return (
    <div>
      ...
      <div className="d-flex gap-2 mt-3">
        <Button variant="outline-light" size="sm" onClick={libros.reload}>Recargar Libros</Button>
        <Button variant="outline-light" size="sm" onClick={alumnos.reload}>Recargar Alumnos</Button>
        <Button variant="outline-light" size="sm" onClick={prestamos.reload}>Recargar Préstamos</Button>
      </div>
